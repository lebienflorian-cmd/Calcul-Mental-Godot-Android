...
func _build_summary_panel(parent: Node) -> void:
	...
	if was_new_best:
		...
		nb.add_theme_font_size_override("font_size", ThemeManager.scaled_i(int(ThemeManager.FONT_MED * 4.0)))
...
func _add_stat(parent: Node, label: String, value: String) -> void:
	...
	v.add_theme_font_size_override("font_size", ThemeManager.scaled_i(int(ThemeManager.FONT_MED * 4.0)))
	parent.add_child(v)
...
func _make_btn(label: String, color: Color, cb: Callable) -> Button:
	...
	b.add_theme_font_size_override("font_size", ThemeManager.scaled_i(int(ThemeManager.FONT_MED * 4.0)))
