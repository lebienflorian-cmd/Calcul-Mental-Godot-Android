...
func _build_ui() -> void:
	...
	mode_label.add_theme_font_size_override("font_size", ThemeManager.scaled_i(int(ThemeManager.FONT_MED * 4.0)))
	...
	profile_label.add_theme_font_size_override("font_size", ThemeManager.scaled_i(int(ThemeManager.FONT_MED * 4.0)))
	...
	daily_best_label.add_theme_font_size_override("font_size", ThemeManager.scaled_i(int(ThemeManager.FONT_LARGE * 4.0)))
	...
	graph_title.add_theme_font_size_override("font_size", ThemeManager.scaled_i(int(ThemeManager.FONT_SMALL * 4.0)))
	...
	hdr_lbl.add_theme_font_size_override("font_size", ThemeManager.scaled_i(int(ThemeManager.FONT_SMALL * 4.0)))
